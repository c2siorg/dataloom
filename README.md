...
A web-based GUI for data wrangling — manage and transform tabular datasets (CSV, TSV, JSON, XLS, XLSX, Parquet) through a graphical interface powered by pandas, without writing code.
...
- Upload and manage datasets in CSV, TSV, JSON, XLS, XLSX, and Parquet formats through a graphical interface
