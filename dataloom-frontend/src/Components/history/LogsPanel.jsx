  ...
  return (
    <div className="p-4 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-lg shadow-sm mx-auto relative group">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-dark-text">Logs</h3>
        <button
          onClick={onClose}
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="min-w-full bg-white dark:bg-dark-surface rounded-lg overflow-hidden">
          <thead className="bg-gray-50 dark:bg-dark-bg">
            <tr>
              <th className="py-3 px-4 border-b border-gray-200 dark:border-dark-border text-left text-xs font-medium text-gray-500 dark:text-dark-muted uppercase tracking-wider">
                Action Type
              </th>
              <th className="py-3 px-4 border-b border-gray-200 dark:border-dark-border text-left text-xs font-medium text-gray-500 dark:text-dark-muted uppercase tracking-wider">
                Timestamp
